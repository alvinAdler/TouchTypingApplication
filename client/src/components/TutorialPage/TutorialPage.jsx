                    ...
                    <ExpandableSection sectionTitle="Menus">
                        ...
                        <div className="menus-content-container">
                            <div className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/mainMenu.png" alt="Tutorial" />
                            ...
                            <div id="navbar" className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/navbarBefore.jpg" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/navbarAfter.jpg" alt="Tutorial" />
                            ...
                            <div className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/login.png" alt="Tutorial" />
                            ...
                            <div className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/register.png" alt="Tutorial" />
                            ...
                            <div className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/practicePageDrill.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/practicePageGame.png" alt="Tutorial" />
                            ...
                            <div className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/summaryDrill.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/historyDrill.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/summaryGame.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/historyGame.png" alt="Tutorial" />
                    ...
                    <ExpandableSection sectionTitle="Mechanism of The Drill Mode and The Game Mode">
                        ...
                        <div className="menus-content-container">
                            <div className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/drillMain.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/drillWordWrapper.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/drillTextHints.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/drillKeyboardHints.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/drillStatusBar.png" alt="Tutorial" />
                                ...
                                <img style={{width: "50%", height: "50%", margin: "1rem auto"}} src="/images/appScreenshots/drillPauseButton.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/drillPause.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/drillResult.png" alt="Tutorial" />
                            ...
                            <div className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/gameMain.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/gameStatusBar.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/gameMainCanvas.png" alt="Tutorial" />
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/gameUserInput.png" alt="Tutorial" />
                    ...
                    <ExpandableSection sectionTitle="Performance Calculations">
                        ...
                        <div className="menus-content-container">
                            ...
                            <div className="content-menu">
                                ...
                                <img className="app-screenshot" src="/images/appScreenshots/gameDevMode.png" alt="Tutorial" />
